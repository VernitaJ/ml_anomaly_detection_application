...
# topic_list = []
# topic_list.append(NewTopic(name="velocity", num_partitions=1, replication_factor=1))
# topic_list.append(NewTopic(name="torque", num_partitions=1, replication_factor=1))
