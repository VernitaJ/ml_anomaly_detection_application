...
notification_layout = html.Div([
    ...
    #         html.Th('predicted'),
    #     ])),
    #     html.Tbody(id='anomaly_table_body')
    # ]),
    dcc.Interval(
        id='interval-component',
...
def update(n, tab, graph):
    ...
    print('current amount', current_amount, 'n', n, 'plotpoints', plotpoints)
...
def update_graph(tab, datatoshow):
    ...
    #                     mode='markers',
    #                     name='anomalies'))
        # px.scatter(x=[anomalies['time']], y=[anomalies[tab]], size=[20], color=['red'])
